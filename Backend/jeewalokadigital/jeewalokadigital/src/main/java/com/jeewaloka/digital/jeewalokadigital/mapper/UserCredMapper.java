...
public class UserCredMapper {
    ...
    public UserCredentials toEntity(UserCredentialsRequestDTO userCredentialsDTO){
        ...
        System.out.println(userCredentialsDTO.getUsermark());
        User user = userRepository.findById(userCredentialsDTO.getUsermark())
                .orElseThrow(() -> new EntityNotFoundException("user not found with id: " + userCredentialsDTO.getUsermark()));
